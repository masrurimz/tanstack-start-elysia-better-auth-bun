...
const Pricing = () => {
  return (
    <section className="container py-24 sm:py-32">
      <h2 className="mb-2 text-lg tracking-wider text-center text-primary">Pricing</h2>

      <h2 className="mb-4 text-3xl font-bold text-center md:text-4xl">
        Get unlimitted access
      </h2>

      <h3 className="pb-14 mx-auto text-xl text-center text-muted-foreground md:w-1/2">
